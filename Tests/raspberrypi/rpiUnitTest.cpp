...
// Function to get WiFi security mode from user
WPEFramework::Exchange::INetworkManager::WiFiSecurity getSecurityType() {
    int securityChoice;
    ...
    switch (securityChoice) {
        ...
        default:
            std::cout << "Invalid choice. Defaulting to WPA/WPA2 PSK AES." << std::endl;
            return WPEFramework::Exchange::INetworkManager::WIFI_SECURITY_WPA_PSK_AES;
    }
}

// Function to print SSIDs from a list
    ...
    while (choice != 0) {
        ...
        switch (choice) {
            ...
            case 7: {
                ...
                WPEFramework::Exchange::INetworkManager::WiFiSecurity securityType = getSecurityType();
